import { Highlights, Tip } from "@/types/workout/workout";
import { WorkoutDTO } from "@/types/workout/workoutDTO";

export const workoutsFixture: WorkoutDTO[] = [
  {
    id: "w-2025-01-22-1",
    title: "Morning Strength",
    muscleGroups: ["chest", "shoulders"],
    mainFocus: "chest",
    scheduledAt: "2026-01-23T09:00:00",
    completedAt: "2026-01-23T11:00:00",
    exercises: [
...
export const tipsFixture: Tip[] = [
  { title: "Stay Hydrated" },
  { title: "Warm Up Properly" },
];

export const recentHighlightsFixture: Highlights[] = [
  { title: "Deadlift PR", subtitle: "200 kg x 3", rightPopup: "+15 kg" },
