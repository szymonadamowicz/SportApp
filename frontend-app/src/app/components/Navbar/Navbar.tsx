              ...
              <li key={item.href} className="relative">
                ...
                {active && (
                  <motion.div
                    ...
                    className="absolute -bottom-[6px] left-0 right-0 h-[2px] bg-gradient-to-r from-accent via-green-400 to-accent rounded-full"
                ...
                {!active && (
                  <motion.div
                    className="absolute -bottom-[6px] left-0 right-0 h-[1px] bg-accent/0 rounded-full"
                    whileHover={{
